...
namespace Magazine.Infrastracture.DB.EntityConfigurations
{
    ...
    public class CommentConfiguration : IEntityTypeConfiguration<Comment>
    {
        public void Configure(EntityTypeBuilder<Comment> builder)
        {
            ...
            builder.HasOne(e => e.Account).WithMany(e => e.Comments).HasForeignKey(e => e.AccountId).HasConstraintName("fk_comment_accountid_account_id").OnDelete(DeleteBehavior.NoAction);
